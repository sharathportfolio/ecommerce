        ...
        <>
            {type === "style-one" ? (
                <div className="testimonial-item style-one h-full">
                    <div className="testimonial-main bg-[#f7f7f7] p-8 rounded-2xl h-full">
                        <Rate currentRate={data.star} size={14} />
                        <div className="heading6 title mt-4 text-black">{data.title}</div>
                        <div className="desc mt-2 text-black">{data.description}</div>
                        <div className="text-button name mt-4 text-black">{data.name}</div>
                        <div className="caption2 date text-secondary2 mt-1 text-black">{data.date}</div>
                    </div>
                </div>
            ) : (
                <>
